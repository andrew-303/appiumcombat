...
/**
 * 03.根据测试平台的不同，生成不同的driver，比如：AndroidDriver,iOSDriver
 * @author HZFI_DC
 *
 */
public class SelectDriver {
	...
	public AppiumDriver<WebElement> selectDriver(ITestContext context,AppiumUtil appiumUtil){
		...
		if(platformName.equalsIgnoreCase("android")){
			//设置和android 测试相关的capabilities并实例化driver对象
			...
			//如果测试平台是ios的话，执行下面这个else if语句内容
		}else if(platformName.equalsIgnoreCase("ios")){
			//设置和ios 测试相关的capabilities并实例化driver对象
